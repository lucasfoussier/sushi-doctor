...
//    public static $config;
     ...
     * @return Model
     */
    public function setDynamoDbClient(DynamoDbClient $client):self{
     ...
     */
    public function setAppStage(string $appStage){
        define('APP_STAGE', $appStage);
        $this->appStage = $appStage;
    }


    public static function convertTableName(string $tableName) :string
    {
...
//    }
    ...
    public static function getById($id)
    {
        ...
        $result = $class::$client->getItem(array(
            'TableName' => self::convertTableName($class::$tableName),
            'Key' => array(
                'id' => array('S' => $id)
            ),
            'ConsistentRead' => true,
